...
async function initializeChapterList() {
    ...
    chapterList = [
        ...
        {
            id: '16',
            title: '第十六章 盖茨与乔布斯 当轨道相交',
            filePath: '/book/乔布斯传/第十六章 盖茨与乔布斯 当轨道相交.md'
        },
        {
            id: '17',
            title: '第十七章 伊卡洛斯 凡升起的……',
            filePath: '/book/乔布斯传/第十七章 伊卡洛斯 凡升起的…….md'
        },
        {
            id: '18',
            title: '第十八章 NeXT 自由的普罗米修斯',
            filePath: '/book/乔布斯传/第十八章 NeXT 自由的普罗米修斯.md'
        },
        {
            id: '19',
            title: '第十九章 皮克斯 技术与艺术相遇',
            filePath: '/book/乔布斯传/第十九章 皮克斯 技术与艺术相遇.md'
        },
        {
            id: '20',
            title: '第二十章 凡人 爱就那么回事',
            filePath: '/book/乔布斯传/第二十章 凡人 爱就那么回事.md'
        },
        {
            id: '21',
            title: '第二十一章 玩具总动员 巴斯和胡迪救场',
            filePath: '/book/乔布斯传/第二十一章 玩具总动员 巴斯和胡迪救场.md'
        },
        {
            id: '22',
            title: '第二十二章 再度降临 何等野兽，终于等到它的时辰',
            filePath: '/book/乔布斯传/第二十二章 再度降临 何等野兽，终于等到它的时辰.md'
        },
        {
            id: '23',
            title: '第二十三章 回归 此刻的失败者终将胜利',
            filePath: '/book/乔布斯传/第二十三章 回归 此刻的失败者终将胜利.md'
        },
        {
            id: '24',
            title: '第二十四章 非同凡想 iCEO乔布斯',
            filePath: '/book/乔布斯传/第二十四章 非同凡想 iCEO乔布斯.md'
        },
        {
            id: '25',
            title: '第二十五章 设计原则 乔布斯和艾弗的工作室',
            filePath: '/book/乔布斯传/第二十五章 设计原则 乔布斯和艾弗的工作室 .md'
        },
        {
            id: '26',
            title: '第二十六章 iMac "你好（又见面了）"',
            filePath: '/book/乔布斯传/第二十六章 iMac "你好（又见面了）".md'
        },
        {
            id: '27',
            title: '第二十七章 CEO 多年之后，疯狂依旧',
            filePath: '/book/乔布斯传/第二十七章 CEO 多年之后，疯狂依旧.md'
        },
        {
            id: '28',
            title: '第二十八章 苹果零售店 天才吧和锡耶纳沙石',
            filePath: '/book/乔布斯传/第二十八章 苹果零售店 天才吧和锡耶纳沙石.md'
        },
        {
            id: '29',
            title: '第二十九章 数字中枢 从iTunes 到iPod',
            filePath: '/book/乔布斯传/第二十九章 数字中枢 从iTunes 到iPod iTunes.md'
        },
        {
            id: '30',
            title: '第三十章 iTunes商店 "我是花衣魔笛手"',
            filePath: '/book/乔布斯传/第三十章 iTunes商店 "我是花衣魔笛手".md'
        },
        {
            id: '31',
            title: '第三十一章 爱音乐的人 他生命中的音乐轨迹',
            filePath: '/book/乔布斯传/第三十一章 爱音乐的人 他生命中的音乐轨迹.md'
        },
        {
            id: '32',
            title: '第三十二章 皮克斯的朋友 ……当然还有敌人',
            filePath: '/book/乔布斯传/第三十二章 皮克斯的朋友 ……当然还有敌人.md'
        },
        {
            id: '33',
            title: '第三十三章 21世纪的Mac 苹果脱颖而出',
            filePath: '/book/乔布斯传/第三十三章 21世纪的Mac 苹果脱颖而出.md'
        },
        {
            id: '34',
            title: '第三十四章 第一回合 死之警示',
            filePath: '/book/乔布斯传/第三十四章 第一回合 死之警示.md'
        },
        {
            id: '35',
            title: '第三十五章 iPhone 三位一体',
            filePath: '/book/乔布斯传/第三十五章 iPhone 三位一体.md'
        },
        {
            id: '36',
            title: '第三十六章 第二回合 癌症复发',
            filePath: '/book/乔布斯传/第三十六章 第二回合 癌症复发.md'
        },
        {
            id: '37',
            title: '第三十七章 iPad 后PC时代',
            filePath: '/book/乔布斯传/第三十七章 iPad 后PC时代 .md'
        },
        {
            id: '38',
            title: '第三十八章 新的战斗 昔日重现',
            filePath: '/book/乔布斯传/第三十八章 新的战斗 昔日重现.md'
        },
        {
            id: '39',
            title: '第三十九章 飞向太空 云端，飞船，宇宙无限 iPad',
            filePath: '/book/乔布斯传/第三十九章 飞向太空 云端，飞船，宇宙无限 iPad.md'
        },
        {
            id: '40',
            title: '第四十章 第三回合 暮色下的抗争',
            filePath: '/book/乔布斯传/第四十章 第三回合 暮色下的抗争.md'
        },
        {
            id: '41',
            title: '第四十一章 遗产 无比辉煌的创新天堂',
            filePath: '/book/乔布斯传/第四十一章 遗产 无比辉煌的创新天堂.md'
        }
    ];
